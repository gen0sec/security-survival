...
const CONFIG = {
  ...
  services: {
    ...
    alb: {
      ...
      tooltip: {
        upkeep: "Medium",
        desc: "<b>Proxy.</b> Fronts your app, routes traffic, and applies edge logic.",
      },
    },
    edge: {
      name: "Edge",
      ...
      tooltip: {
        upkeep: "Low",
        desc: "<b>Edge.</b> Entry point that routes to Proxy or Firewall.",
      },
    },
    compute: {
      name: "Compute",
    ...
    content: {
      ...
      tooltip: {
        upkeep: "Medium",
        desc: "<b>Content Scanning.</b> Inspects payloads for malware or abuse.",
      },
    },
    intel: {
      ...
      tooltip: {
        upkeep: "Medium",
        desc: "<b>Cyber Intelligence.</b> Correlates signals to improve detection.",
      },
    },
    siem: {
      name: "SIEM",
      ...
      tooltip: {
        upkeep: "High",
        desc: "<b>SIEM.</b> Aggregates logs for monitoring and response.",
      },
    },
  },
  survival: {
